...
und zusammengesetzt aus der grün markierten \texttt{chain} und der schwarzen 
  ...
  \todo{papa versteht den letzten absatz nicht}
...
werden.
\todo{
  Das ganze Kapitel ist eigentlich in 2 Schritte aufgeteilt. Hier tauchen plötzlich 3 Schritte auf. Kannst du die 3 Optimierungsschritte vielleicht durch Stufen oder Zyklen ersetzen?
}
